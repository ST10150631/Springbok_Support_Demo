...
## Prerequisites:
System Requirements
Operating System: Windows 10 or later (for WPF development, Windows is required).
Processor: 1.8 GHz or faster processor.
RAM: 4 GB or more (8 GB recommended for larger projects).
Disk Space: Minimum 2 GB of free space for development tools and project files.
Software Requirements
Visual Studio:
You must have Visual Studio installed. It is recommended to use the latest stable version of Visual Studio for the best experience.

Visual Studio 2022 or later.
.NET Desktop Development workload enabled during installation.
.NET SDK:
The project is developed using the .NET framework or .NET Core (depending on your project type). Ensure you have the correct version of the SDK installed.

For .NET Core / .NET 5+:
Download .NET SDK

For .NET Framework:
Ensure that you have the correct version of the .NET Framework installed (typically 4.5 or higher).

Microsoft Visual C++ Redistributable (if required):

Some projects may require the Microsoft Visual C++ Redistributable for Visual Studio. You can download it here.
...
3.	Click on the file.
4.	Open this file using Visual Studio
5.	Build the project by clicking on the hammer icon in the toolbar
6.	Press the play button at the top of the screen if this does not work first time click the little arrow next to the play button and select your desired web browser and try again.
7.	The app will now open.
8.	Wait for the app to load and you’ll be able to use it!
...
## Navigating through media in events and announcements
...
## New and Impoved message boxes
The messages boxes have been styled to suit the app :
![image](https://github.com/user-attachments/assets/86170c95-f9b4-4011-af59-4901e55ed320)

## Service Status Page 
- A service status page has been created to view various report data suchj as total completed, in progress and submitter reports
- Reports added by date
- Most frequently reported categories
- Reports per province
- A table displaying reports ordered by oldest first and status closer to completion => Top

- 
  ![image](https://github.com/user-attachments/assets/539fd87c-7217-4176-b2fe-fd4811a2254c)

## View All reports now located in the service status
- Can be navigated to by clicking the button at the top right labeled View All reports

  
- ![image](https://github.com/user-attachments/assets/9f98a2e2-79e1-4e00-ab5b-7b150cc116c8)

![image](https://github.com/user-attachments/assets/d23a772a-d649-4640-b926-e324455cc1fd)

## More Dummy Data
![image](https://github.com/user-attachments/assets/cb515911-5bcf-4946-b571-a404464858fc)

## Bug Fixes:
- Improved message boxes
- Improved Validation
- Improved Reccomendations
- Improvements to UI

## New Data structures 
For more information please refer to the Data structures Document
